...
The user (i.e. another class) of the instantiable class GuessNumber should provide the guessed
number via the setGuess() method.
 */
public class GuessNumber {
    ...
    private String message; // instance variable to store mesage whether the number == or <, >

    public GuessNumber() {
        //generate a random number between 1 and 10
//		double r1 = Math.random(); //generate a random number
//		double r2 = r1*10; //[0...9]
...
//		secret = (int) r3;
        ...
        //option 2
        secret = (int) (Math.random()*10) + 1; //one line alternative option
    ...
    //getter method to retrieve the secret answer number generated by the CPU
